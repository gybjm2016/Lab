...
ExtDecList	: VarDec			{$$ = setnode("ExtDecList","",@$.first_line);addnode($$,$1);}
		...
		| VarDec error ExtDecList	{iserror=1;printf("Error type B at line %d :Missing ,\n",@$.first_line);};
...
VarList		: ParamDec COMMA VarList	{$$ = setnode("VarList","",@$.first_line);addnode($$,$1);addnode($$,$2);addnode($$,$3);}
		...
		| ParamDec error VarList	{iserror=1;printf("Error type B at line %d :Missing ,\n",@$.first_line);};
...
DecList		: Dec				{$$ = setnode("DecList","",@$.first_line);addnode($$,$1);}
		...
		| Dec error DecList		{iserror=1;printf("Error type B at line %d :Missing ,\n",@$.first_line);};
